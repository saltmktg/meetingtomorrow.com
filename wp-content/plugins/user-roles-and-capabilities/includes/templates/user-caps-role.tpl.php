                            ...
                            <p>
                                ...
                                <select id="primary_role" name="primary_role">
                                    <?php foreach ($user_roles as $key => $role) { ?>
                                        <option value="<?php print $key; ?>" <?php if ($key == $this->user->roles[0]) { print "selected"; } ?>> <?php print $role['name']; ?> </option>
                                    <?php } ?>
                                </select> 
                            </p>
                            <p>
                                ...
                                foreach ($user_roles as $key => $role) {
                                   // if ($key != $this->user->roles[0]) {
                                        ?>
                                        <input type="checkbox" name="secondary_roles[<?php print $key; ?>]" <?php if (in_array($key, $this->user->roles) && $key != $this->user->roles[0]) { print "checked"; } ?>> <?php print $role['name'] ?> <br/>
                                    <?php
                               // }
                            }
                            ?>
