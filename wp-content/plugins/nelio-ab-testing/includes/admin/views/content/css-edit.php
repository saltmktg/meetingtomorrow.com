...
class NelioABCssEditPage extends NelioABAdminAjaxPage {
	...
	public static function build() {
		...
		if ( isset( $_POST['post_title'] ) )
			$view->keep_request_param( 'css_alt_name', stripslashes( $_POST['post_title'] ) );
		if ( isset( $_POST['content'] ) )
			$view->keep_request_param( 'css_alt_value', stripslashes( $_POST['content'] ) );
	...
	public static function generate_html_content() {
		...
		if ( isset( $_REQUEST['css_save_alt'] ) &&
			...
			$exp->update_css_alternative(
				$css_id, stripslashes( $_REQUEST['css_alt_name'] ), stripslashes( $_REQUEST['css_alt_value'] ) );
		}
