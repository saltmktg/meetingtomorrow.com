...
if ( !class_exists( 'NelioABFreeTrialPage' ) ) {
	...
	class NelioABFreeTrialPage extends NelioABAdminPage {
		...
		public function print_twitter_content() {
			...
			$texts = array(
				__( 'I\'m trying out Nelio A/B Testing for #WordPress by @NelioSoft and it rocks! Check it out at', 'nelioab' ),
				__( 'Nelio A/B Testing for #WordPress by @NelioSoft looks awesome! Check it out at', 'nelioab' ),
				__( 'I\'m trying out Nelio A/B Testing by @NelioSoft and it looks great! Check it out at', 'nelioab' ),
				__( 'Nelio A/B Testing is a great tool for split-testing a #WordPress site. Find it here: ', 'nelioab' ),
				__( 'The guys at @NelioSoft did a great job with Nelio A/B Testing for #WordPress. Look:', 'nelioab' ),
				__( 'I\'m on Nelio A/B Testing\'s Free Trial and I really like the product. Check it out at: ', 'nelioab' )
			);
		...
		public function print_subscribe_content() {
			...
			echo '<p class="cta">';
			$link = 'https://nelioabtesting.com/subscription-plans/?plugin=ft-quota';
