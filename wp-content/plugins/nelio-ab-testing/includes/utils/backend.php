...
if ( !class_exists( 'NelioABBackend' ) ) {
	...
	abstract class NelioABErrCodes {
		 ...
		 * @var int
		 */
		const YOU_DONT_HAVE_PERMISSION = -12;
			...
			switch( $err ) {
				...
				case NelioABErrCodes::MULTI_PAGE_GOAL_NOT_ALLOWED_IN_BASIC:
					return sprintf(
						...
						'https://nelioabtesting.com/inquiry-subscription-plans/?plugin=mge-basic' );
				...
				case NelioABErrCodes::HEATMAP_NOT_ALLOWED_IN_BASIC:
					return sprintf(
						...
						'https://nelioabtesting.com/inquiry-subscription-plans/?plugin=hme-basic' );
				...
				case NelioABErrCodes::YOU_DONT_HAVE_PERMISSION:
					return __( 'You don\'t have permission to perform this action.', 'nelioab' );
