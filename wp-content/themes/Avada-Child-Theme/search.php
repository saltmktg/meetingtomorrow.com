<?php get_header(); ?>
	...
	<div id="content" class="<?php echo $content_class; ?>" style="<?php echo $content_css; ?>">
		...
		<div class="timeline-icon<?php echo $timeline_icon_class; ?>"><i class="fusionicon-bubbles"></i></div>
			...
			<div id="posts-container" class="<?php echo $container_class; ?> clearfix">
				...
				<h3 class="search-heading bot-mar-40">Search Results:</h3>
	...
	<div class="post-content">
		<div class="fusion-title title">
			<h2 class="title-heading-left"><?php echo __('Sorry, we couldn\'t find what you\'re looking for!', 'Avada'); ?></h2><div class="title-sep-container"><div class="title-sep sep-double"></div></div>			
		</div>
		<div class="error_page">
			<div class="fusion-one-half one_half fusion-column">
				...
				<?php wp_nav_menu(array('theme_location' => 'main_navigation', 'depth' => 1, 'container' => false, 'menu_id' => 'main_navigation', 'menu_class' => 'list-icon circle-no list-icon-arrow')); ?>
			</div>
			<div class="fusion-one-half one_half fusion-column last">
				<h3><?php echo __('Or try another search:', 'Avada'); ?></a></h3>
				<!--<p><?php echo __('If you want to rephrase your search terms, you can do here:', 'Avada'); ?></p>-->
				<form class="searchform seach-form" role="search" method="get" action="<?php echo home_url( '/' ); ?>">
					<div class="search-table">
						<div class="search-field">
							<input type="text" value="" name="s" class="s" placeholder="<?php _e( 'Search ...', 'Avada' ); ?>"/>
