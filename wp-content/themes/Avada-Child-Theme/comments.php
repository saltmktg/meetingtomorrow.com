...
<?php if ( have_comments() ) : ?>
  ...
  <div id="comments" class="comments-container">
    <div class="title fusion-title"><h3 class="title-heading-left"><?php comments_number(__('No Comments', 'Avada'), __('One Comment', 'Avada'), '% '.__('Comments', 'Avada'));?></h3><div class="title-sep-container"><div class="title-sep sep-double"></div></div></div>
