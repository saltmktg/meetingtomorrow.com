<?php get_header(); ?>
	...
	$avatar	   = get_avatar( get_the_author_meta('email', $author_id), '118' );
	$description  = get_the_author_meta('description', $author_id);
	$author_custom = get_the_author_meta('author_custom', $author_id);

	if(empty($description)) {
		$description  = __('','Avada');
		$description .= '<br />'.sprintf( __( '%s has created %s blog entries.', 'Avada' ), $name, count_user_posts( $author_id ) );
	}
	?>
	<div id="content" class="<?php echo $content_class; ?>" style="<?php echo $content_css; ?>">
		<div class="author">
			...
			<h1 class='author_title vcard'><?php echo __( 'About', 'Avada'); ?> <span class="fn"><?php echo $name; ?></span>
		...
		<h2 class="author-posts-title">Posts by <?php echo $name; ?>:</h2>
