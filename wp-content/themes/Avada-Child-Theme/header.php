...
<head>
  ...
  <!-- START Google Analytics A/B Testing Scripts -->
...
<body <?php body_class( $body_classes ); ?> data-spy="scroll" onload="setTimeout("populateHiddenFields(document.forms['ga-tracking-form']"), 10000);" onload="_googWcmGet('phone-number-link', '1.877.633.8866')">
